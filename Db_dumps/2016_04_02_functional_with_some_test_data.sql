...
--
-- Host: localhost
-- Czas wygenerowania: 02 Kwi 2016, 16:53
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci AUTO_INCREMENT=4 ;

--
-- Zrzut danych tabeli `Marks`
--

INSERT INTO `Marks` (`id`, `student_id`, `class_id`, `description`, `mark`) VALUES
(1, 1, 1, 'gupi opis', 5),
(2, 1, 1, 'Å‚adne oczy', 5),
(3, 5, 1, 'bo go lubie', 4);
...
CREATE TABLE IF NOT EXISTS `students_classes` (
  ...
  KEY `student_id` (`student_id`),
  KEY `class_id` (`class_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci AUTO_INCREMENT=13 ;
